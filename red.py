...
# prismaNOW, a Discord bot alias of Red - Discord Bot modified by novocytal, base code by Twentysix.
# Based on discord.py and its command extension.
#
#                   https://github.com/Twentysix26/
#                   https://github.com/novocytal/
#
#
...
description = "prismaNOW • multifunction music and social bot by novocytal"
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits prismaNOW with exit code 0

        If restart is True, the exit code will be 26 instead
        The launcher automatically restarts prismaNOW when that happens"""
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        if bot.settings.token and not bot.settings.self_bot:
            ...
            url = "http://prismanow.us.to/"
            print(url)

        print("\nOfficial server: https://discord.gg/6HPCfcK")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Prisma • First run configuration\n")
    ...
    if first_run:
        ...
        print("\nThe configuration is done. Leave this window always open to"
              ...
              "Please read this guide for a good overview on how Prisma works:\n"
...
def load_cogs(bot):
    ...
    if owner_cog is None:
        print("The owner cog is missing. It contains core functions without "
              "which Prisma cannot function. Reinstall.")
        exit(1)
