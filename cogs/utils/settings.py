...
class Settings:
    ...
    def parse_cmd_arguments(self):
        parser = argparse.ArgumentParser(description="prismaNOW 2.0.9_d")
        parser.add_argument("--owner", help="ID of the owner. Only who hosts "
                                            "Prisma should be owner, this has "
        ...
        parser.add_argument("--admin-role", help="Role seen as admin role by "
                                                 "Prisma")
        parser.add_argument("--mod-role", help="Role seen as mod role by Prisma")
        ...
        parser.add_argument("--no-cogs",
                            action="store_true",
                            help="Starts Prisma with no cogs loaded, only core")
        parser.add_argument("--self-bot",
                            action='store_true',
                            help="Specifies if Prisma should log in as selfbot")
        ...
        parser.add_argument("--dry-run",
                            action="store_true",
                            help="Makes Prisma quit with code 0 just before the "
